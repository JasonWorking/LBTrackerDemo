...
@property (nonatomic,strong) NSString *mcc;/**< 国家代码*/
@property (nonatomic,strong) NSString *mnc;/**< 网络代码*/
@property (nonatomic,strong) NSString *wifiNoteName;/**< wifi的名字*/
@property (nonatomic,strong) NSString *wifiActive;/**< 是否有wifi*/
